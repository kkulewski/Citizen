...
namespace Citizen.Data.Migrations
{
    ...
    [Migration("20170624211826_FixUserFoodItemRelation")]
    partial class FixUserFoodItemRelation
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Citizen.Models.Items.FoodItem", b =>
                {
                    b.Property<string>("ApplicationUserId");

                    b.Property<int>("Amount");

                    b.Property<int>("EnergyRecoverAmount");
            ...
            modelBuilder.Entity("Citizen.Models.Items.FoodItem", b =>
                {
                    b.HasOne("Citizen.Models.ApplicationUser", "ApplicationUser")
                        .WithOne("FoodItem")
                        .HasForeignKey("Citizen.Models.Items.FoodItem", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
