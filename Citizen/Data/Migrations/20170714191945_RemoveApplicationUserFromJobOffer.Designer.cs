...
namespace Citizen.Data.Migrations
{
    ...
    [Migration("20170714191945_RemoveApplicationUserFromJobOffer")]
    partial class RemoveApplicationUserFromJobOffer
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Citizen.Models.Employment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Citizen.Models.JobOffer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Citizen.Models.Company", b =>
                {
                    b.HasOne("Citizen.Models.ApplicationUser", "Owner")
                        .WithMany("Companies")
            ...
            modelBuilder.Entity("Citizen.Models.Employment", b =>
                {
                    b.HasOne("Citizen.Models.ApplicationUser", "ApplicationUser")
                        .WithOne("Employment")
                        .HasForeignKey("Citizen.Models.Employment", "ApplicationUserId");

                    b.HasOne("Citizen.Models.Company", "Company")
